...
//
// hjo224@lehigh.edu | Hayden: The below imageMap is just a map taking the path and then returning the URL to pull from the DB. 
// I honestly dont know if it makes more sense to just keep this local. 
//
// jac927@bu.edu | James: I think Hayden's decision to use db file storage over local file storage is correct for our use case.
