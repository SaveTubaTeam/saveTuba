    ...
    <SafeArea style={{backgroundColor: "#CCE882"}}>
      <ScrollView style={{ alignContent: "center"}}>
        <ImageBg source={require("../../../assets/leveloneBack.png")}>
          ...
          <TouchableOpacity style={style.roundButton1} onPress={() => navigation.push("LessonOne")}>
            <Text style={style.baseText}>1</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton2} onPress={() => navigation.push("Two")}>
            <Text style={style.baseText}>2</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton3} onPress={() => navigation.push("Three")}>
            <Text style={style.baseText}>3</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton2} onPress={() => navigation.push("Four")}>
            <Text style={style.baseText}>4</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton1} onPress={() => navigation.push("Five")}>
            <Text style={style.baseText}>5</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton2} onPress={() => navigation.push("Six")}>
            <Text style={style.baseText}>6</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton3} onPress={() => navigation.push("Seven")}>
            <Text style={style.baseText}>7</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton2} onPress={() => navigation.push("Eight")}>
            <Text style={style.baseText}>8</Text>
          </TouchableOpacity>
          <TouchableOpacity style={style.roundButton1} onPress={() => navigation.push("Nine")}>
